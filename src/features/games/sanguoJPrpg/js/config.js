...
const MESSAGES = {
    ...
    M_UNLOCK: ["矿区封印已破除!", "Mine unsealed!", "#FFFFFF"],
    LOCK: ["被妖怪封锁中", "Sealed by monsters", "#888888"],
    UNLOCK: ["解锁成功", "Unlock", "#FFFFFF"],
    M_COMP: ["矿区攻占成功!", "Mine captured!", "#FF00FF"],
    M_OK: ["攻占进行中>击退妖怪", "Attacking>Success", "#FFFFFF"],
    M_OK2: ["征收矿石>成功", "Mining>Success", "#FFFF00"],
    M_NG: ["行动力不足!", "Not enough ACT!", "#888888"],
    M_ALL: ["全部矿区已攻占!", "All mines captured!", "#FF00FF"],
