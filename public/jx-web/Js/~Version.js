...
var VNum=Lang["Version_16"]+"v1.1.3";                 
...
function DoVersion()
{
    ...
    else if(VersionInfo[0]=="kfc")
    {
        ...
        {
            ToMain="http://www.163.com";
            ToForum="http://www.baidu.com";
            ToGold="http://www.sohu.com";
            ToExit="http://www.sina.com";
        }
	    else 
	    {   
	        ToMain="http://game.koowo.com/g/st/Game?id=5";
    ...
    else if(VersionInfo[0] == "tw")
    {
        ...
        ToForum = "http://jx.941wan.com.tw/index.html";
